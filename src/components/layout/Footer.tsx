        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4 sm:mb-6">
              <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-gradient-to-r from-[#FCB283] to-[#AA4626] flex items-center justify-center text-xl sm:text-2xl">
                🐱
              </div>
              <div>
          ...
          <div>
            ...
            <div className="flex space-x-3 sm:space-x-4">
              ...
              <SocialButton icon="🎵" href="#" label="TikTok" />
              <SocialButton icon="📺" href="#" label="YouTube" />
            </div>
...
const SocialButton = ({ icon, href, label }: { icon: string; href: string; label: string }) => (
  <a 
    href={href}
